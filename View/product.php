	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
                    ...
                    ?>
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $category['cat_name'];?>">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
						<img src="<?php echo "../admin" . substr($product['product_image'],2); ?>" height=270 width=50 alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php?id=<?php echo $product['product_id'];?>" class="stext-104 cl4 hov-cl1 p-b-6">
