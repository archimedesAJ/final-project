							...
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
                                    ...
                                    <form action="../Actions/edit_cart.php" method="post">
                                        <input type='number' class="d-flex flex-row align-items-center" name='qty' style="width: 50%; border: 10px;" value="<?php echo $cart['qty']?>">
									...
									<td class="column-6">
										...
										&nbsp;&nbsp;<button type="submit" class='btn-success' name="update_cart"><i style="font-size: 19px;" class="zmdi zmdi-check"></i></button>         
									</td>
									</form>
								</tr>
                               <?php
