		...
		<div class="container">
			...
			<?php
                if(isset($_POST['search'])){
                    ...
                    $product_search = select_product_search_controller($keyword);
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
						    <img src="<?php echo "../admin" . $search['product_image']; ?>" height=270 width=50 alt="IMG-PRODUCT">

							<a href="product-detail.php?id=<?php echo $search['product_id'];?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15">
								Quick View
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php?id=<?php echo $search['product_id'];?>" class="stext-104 cl4 hov-cl1 p-b-6">
									<?php echo $search['product_title']; ?>
								</a>

								<span class="stext-105 cl3">
									<?php echo "GHS"." ". $search['product_price']; ?>
								</span>
							</div>
