...
<html lang="en">
<head>
	<title>Tailored Hands | About</title>
	<meta charset="UTF-8">
		...
		<div class="container">
				...
				<div class="col-md-7 col-lg-8">
					<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
							Tailored Hands is a bespoke men's and women's apparel brand that seeks to tailor each man's outfit in quality, physique, and style, to fit each occasion. 
						</p>

						<p class="stext-113 cl6 p-b-26">
						Our products are handcrafted through relaxed tailoring with meticulous attention to details. With the drive of doing well whilst doing good. 
						</p>
			...
			<div class="row">
				...
				<div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
					<div class="how-bor2">
						<div class="hov-img0">
							<img src="../images/tailored-hand-logo.png" alt="IMG">
						</div>
					</div>
				</div>
			</div>
