...
<html lang="en">
<head>
	<title>Tailored | Shoping Cart</title>
	<meta charset="UTF-8">
					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<?php
								if (empty($carts)){
									echo "<h5 style='color: blue'>No cart added! <h5>";
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="<?php echo "../admin" . $cart['product_image']; ?>" alt="IMG">
										</div>
									</td>
									<td class="column-2"><?php echo $cart['product_title'] ?></td>
									<td class="column-3"><?php  echo "GHS"." ". $cart['product_price']?></td>
									<td class="column-3">&nbsp; &nbsp; &nbsp;<?php echo "&nbsp". " ".$cart['qty'] ?></td>
									<td class="column-5"><?php echo "GHS"." ".$total ?></td>
									<td class="column-6">
										<a href="../Actions/remove_from_cart.php?removeProd_ID=<?php echo $cart['p_id']?>"><i style="font-size: 19px; color: red" class="zmdi zmdi-delete"></i></a>
										&nbsp;&nbsp;&nbsp;<a href="edit_shoping_cart.php?product_id=<?php echo $cart['p_id']?>"><i style="font-size: 19px; color: blue;" class="zmdi zmdi-edit"></i><a>&nbsp;
						...
						<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
							...
							<div class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
								<a href="product.php" style="color: black"><i style="font-size: 18px" class="zmdi zmdi-arrow-left"></i>&nbspContinue Shopping</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
							<a href="checkout.php" style="color: white">Proceed to Checkout</a>
						</button>
					</div>
				</div>
			</div>
