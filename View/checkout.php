...
//Check whether a user is logined if by calling the checklogin() from the core.php
check_login();
?>
...
<body class="animsition">
    ...
    <div class="cart_section" style="padding-top: 0; margin-left: 50px;">
         <div class="container-fluid" style="padding-left: 17px">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cart_container">
                        ...
                        ?>
                        <div class="order_total" style="padding: 0; padding-bottom: 50px;">
                            <div class="order_total_content text-md-right">
                                <div class="order_total_title">ORDER TOTAL:</div>
                                <div class="order_total_amount"><?php echo "GHS"." ". $amt['amount']?></div>
                            </div>
                        </div>
                        <div class="cart_buttons" style="padding-bottom: 0;"> <button type="button" class="button cart_button_clear"><a href="shoping-cart.php" style="color: gray">Back to Cart</a></button> <button type="button" class="button cart_button_checkout"><a href="payment.php"> Make Payment</a></button> </div>
                    </div>
                </div>
            </div>
        </div>
		...
		<div class="container">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Tailored Hands <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Anidaso Technologies</a> 
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
