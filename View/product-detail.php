...
<html lang="en">
<head>
	<title>Tailored Hands | Product Detail</title>
	<meta charset="UTF-8">
...
<body class="animsition">
	...
	<header class="header-v4">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.php"><img src="../images/icons/tailored-hand-logo.png" alt="IMG-LOGO"></a>
			</div>
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			...
			<span class="stext-109 cl4">
				<?php echo  $prod_details['product_title'] ;?>
			</span>
		</div>
	</div>
	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="<?php echo "../admin" . substr($prod_details['product_image'],2); ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="<?php echo "../admin" . $prod_details['product_image']; ?>" alt="IMG-PRODUCT">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2">
							<?php echo "GHS"." ". $prod_details['product_price']; ?>
						</span>

						<p class="stext-102 cl3 p-t-23">
							<?php echo "<i><b>Description</b></i>". " "."<b>:</b> ".$prod_details['product_desc']; ?>
							<br>
							<br>
							<?php echo "<i><b>Keyword</b></i>". " "."<b>:</b> ".$prod_details['product_keywords']; ?>
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15">
										<a href="../Actions/add_to_cart.php?product_id=<?php echo $prod_details['product_id']?>" style="color: white">Add to cart</a>
									</button>
								</div>
							</div>	
						</div>
					...
					<div class="tab-content p-t-43">
						...
						<div class="tab-pane fade show active" id="description" role="tabpanel">
							<div class="how-pos2 p-lr-15-md">
								...
								<?php echo $prod_details['product_desc'] ." . "."Fits in every occasions; be it wedding, parties, outdooring etc.". " "."Try it and you'll thank Tailored Hands later. Wear quality, look smart with Tailored Hands."?>
								</p>
							</div>
						</div>
		...
		<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
			...
			<span class="stext-107 cl6 p-lr-25">
				Categories: <?php echo $cat_name['cat_name']?>
			</span>
		</div>
	</section>
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								...
								<a href="product-detail.php?id=<?php echo $product['product_id']?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
									Quick View
								</a>
							</div>
				...
				<div class="row">
					<div class="col-md-6 col-lg-7 p-b-30">
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="<?php echo "../admin" . $prod_details['product_image']; ?>">
										<div class="wrap-pic-w pos-relative">
											<img src="<?php echo "../admin" . $prod_details['product_image']; ?>" alt="IMG-PRODUCT">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							...
							<p class="stext-102 cl3 p-t-23">
								<?php echo  $prod_details['product_desc']; ?>
							</p>
